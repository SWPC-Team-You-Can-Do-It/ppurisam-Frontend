// Frontend/src/components/chatbot/Robot/RobotIcon.jsx
...
const svgCode = `
  <!-- Frontend/src/components/chatbot/Robot.svg -->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 800">
  <circle id="robot-background-circle" cx="300" cy="400" r="290" fill="#84eeb0" />
  <g id="left_arm">
