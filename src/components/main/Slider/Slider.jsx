...
import leftArrow from "@/assets/images/Slider/left_arrow.png";
import rightArrow from "@/assets/images/Slider/right_arrow.png";
          ...
          <div className="slider__img-wrapper">
            {slides.map((slide, index) => {
              ...
              if (index === currentIndex) {
                ...
                index ===
                (currentIndex - 1 + slideLength) % slideLength
              ) {
                className += " prevSlide";
