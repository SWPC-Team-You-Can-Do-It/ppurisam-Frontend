...
const SendPageContact = forwardRef(({ messageTitle, messageContent }, ref) => {
  ...
  return (
    <div className="SendPageContact_contact-form-wrapper" ref={ref}>
      ...
      <div className="SendPageContact_sender-section2">
        ...
        <div className="SendPageContact_sender-input-wrapper">
          ...
          <div className="SendPageContact_sender-buttons">
            <button
              className="SendPageContact_delete-button"
              onClick={handleDeleteSender}
            >
              삭제
            </button>
            <button
              className="SendPageContact_register-button"
      ...
      <div className="SendPageContact_receiver-contact-wrapper">
        <div className="SendPageContact_receiver-section">
          ...
          <div className="SendPageContact_receiver-buttons">
            <button
              className="SendPageContact_address-button"
              onClick={openModal}
            >
              주소록
            </button>
            ...
            <label
              ...
              className="SendPageContact_excel-button"
            >
              엑셀 붙여넣기
            </label>
          </div>
          ...
          />
          <button
            className="SendPageContact_add-number-button"
        ...
        <div className="SendPageContact_contact-list-section">
          <div className="SendPageContact_contact-list-header">
            <h2>받는사람</h2>
            <button
              className="SendPageContact_clear-all-button"
      ...
      {/* 발송 버튼 */}
      <button
        className="SendPageContact_submit-button2"
...
// PropTypes 정의
SendPageContact.propTypes = {
  messageTitle: PropTypes.string,
  messageContent: PropTypes.string,
};

// 디버깅을 위한 displayName 설정
SendPageContact.displayName = "SendPageContact";
